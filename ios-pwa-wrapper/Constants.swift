...
let appTitle = "Kuis Milioner"
let webAppUrl = URL(string: "https://www.kuismilioner.com")
let allowedOrigin = "kuismilioner.com"
...
let navigationBarColor = getColorFromHex(hex: 0x55bca0, alpha: 1.0)
let navigationTitleColor = getColorFromHex(hex: 0xFFFFFF, alpha: 1.0)
let navigationButtonColor = navigationTitleColor
let progressBarColor = getColorFromHex(hex: 0x55bca0, alpha: 1.0)
